...
public final class CSSFactory {
	...
	public static final StyleSheet parse(URL url, String encoding)
		...
		return getCSSParserFactory().parse((Object) url, encoding, SourceType.URL, url);
	}
	...
	public static final StyleSheet parse(String css) throws IOException,
		...
		return getCSSParserFactory().parse(css, null, SourceType.EMBEDDED, base);
	}
     ...
     */
    public static final StyleSheet getUsedStyles(Document doc, String encoding, URL base, MediaSpec media, StyleSheet style)
    {
    ...
    /**
     * This is the same as {@link CSSFactory#getUsedStyles(Document, String, URL, MediaSpec, Stylesheet)} but
     * a new StyleSheet is created instead of appending to one.
     * 
     * @param doc
     *            DOM tree
     * @param encoding
	...
	public static final StyleSheet getUsedStyles(Document doc, String encoding, URL base, MediaSpec media)
    {
        ...
        return getUsedStyles(doc, encoding, base, media, style);
    }
		...
		protected void processNode(StyleSheet result, Node current,	Object source) 
		{
			...
			try {
				...
				if (isEmbeddedStyleSheet(elem, media)) {
					result = pf.append(extractElementText(elem), null,
				...
				// linked style-sheet
					...
					result = pf.append(uri, encoding, SourceType.URL,
							result, uri);
